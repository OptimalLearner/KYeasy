export default {
    ...
    saveRecordedStream(stream, user, latitude, longitude) {
        console.log('hello')
        ...
        blobToBase64(blob, function (base64) { // encode
            ...
            $.post('/save_recording', { 'blob': base64, 'user': user, 'latitude': latitude, 'longitude': longitude })
                .done(function (new_recording) {
                    ...
                    function notify() {
                        var notification = new Notification('KYeasy', {
                            body: "Congratulations!! Your vKYC has been successfully completed!",
                        });
