    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    walletPath = path.join(process.cwd(), '/connect/Org1Wallet');
                ...
                case 1:
                    ...
                    connectionProfilePath = path.join('D:/kyc_hyperledger/server/', '/connect/connection.json');
                ...
                case 3:
                    network = _a.sent();
                    contract = network.getContract('smart_contract');
                    // Submit the specified transaction.
                    return [4 /*yield*/, contract.submitTransaction('createKyc', rd1[0], rd1[1])];
                case 4:
                    // Submit the specified transaction.
                    _a.sent();
